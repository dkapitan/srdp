# STAGE spoke. project_id, hub_project_id, hub_vpc_id, prefix, region, zone and
...
pn_vpc_cidr    = "10.30.0.0/16"
pn_subnet_cidr = "10.30.0.0/20"

# --- Kapsule sizing (stage: production-like). -------------------------------
system_node_count = 2
compute_node_type = "POP2-8C-32G"
compute_min_count = 0
compute_max_count = 3

# --- Postgres (stage: general-purpose, no HA). ------------------------------
postgres_node_type = "DB-GP-S"
postgres_ha        = false
