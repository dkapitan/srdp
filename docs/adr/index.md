...
| [0003 — Data catalog, lineage, and observability](./0003-data-catalog-lineage-and-observability.md) | Proposed | DuckLake as mandatory IO wrapper, OpenLineage core via Marquez, layered observability, failure-mode matrix and drift detection |
