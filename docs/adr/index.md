...
| [0006 — Deployment and project isolation model](./0006-deployment-and-project-isolation-model.md) | Accepted | Deployment is the isolation unit; a project is its own DuckLake catalog (project/layer/entity) |
